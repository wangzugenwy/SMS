...
<td style="width:10px;"></td>
 <form action="servlet/MessageServlet?action=deletemessage&status_flag=1" method="post">
  ...
  <tr>
    <td width="80" align="center" valign="middle"><input type="submit" value="删除" width="60" height="35" border="0" /></td>
...
<table width="760" cellspacing="0" cellpadding="0" border="0" style=" border-bottom:4px #7ECAFE solid;">
  <tr style="height:35px;  background:#7ECAFE;">
